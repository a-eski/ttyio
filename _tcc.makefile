...
main_flags = -Wall -Wextra -Werror -pedantic -Wsign-conversion -Wformat=2 -Wshadow -Wvla -fstack-protector-strong -fPIC -fPIE -Wundef -Wbad-function-cast -Wcast-align -Wstrict-prototypes -Wnested-externs -Winline -Wdisabled-optimization -Wunreachable-code -Wchar-subscripts
...
ifeq ($(RELEASE), 1)
	...
	cc_with_flags = tcc $(STDFLAG) $(CFLAGS) $(DEFINES)
else
	CFLAGS ?= $(debug_flags)
	cc_with_flags = tcc $(STDFLAG) $(CFLAGS) $(DEFINES)
endif
