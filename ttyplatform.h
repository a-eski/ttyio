...
#if defined __cplusplus || __STDC_VERSION__ >= 202311L /* C23 */
...
#if (!defined(__cplusplus) && __STDC_VERSION__ < 202311L) || defined(_WIN32) || defined(_WIN64) || defined(__APPLE__) || defined(__FreeBSD__) || defined(__OpenBSD__) || defined(__NetBSD__) && (!defined(__MINGW32__) && !defined(__MINGW64__))
